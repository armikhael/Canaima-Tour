...
function EmailSystem($parent){
	...
	this.init = function(){
		emails.push(new Email(0,'inbox', $.trim(_email_1_title_), $.trim(_email_1_body_), 'Carlos Espinoza', $.trim(_you_)));
		emails.push(new Email(1,'inbox',$.trim(_email_2_title_),$.trim(_email_2_body_),'Erick Birbe', $.trim(_you_)));
		emails.push(new Email(2,'inbox',$.trim(_email_3_title_),$.trim(_email_3_body_),'Sasha Solano', $.trim(_you_)));
		emails.push(new Email(3,'inbox',$.trim(_email_4_title_),$.trim(_email_4_body_),'Francisco Vásquez', $.trim(_you_)));
		emails.push(new Email(4,'inbox',$.trim(_email_5_title_),$.trim(_email_5_body_),'Luis Martínez', $.trim(_you_)));
